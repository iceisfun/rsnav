...
| `rsnav-triangle` | The CDT itself — an independent implementation inspired by Shewchuk's Triangle (not a port), plus the crossing-tolerant inset front end. | `delaunay`, `DivConqOptions`, `form_skeleton`, `carve_holes`, `clip_ears`, `Pslg` and friends, `CdtMesh`, `build_cdt_with_inset`, `InsetRing`, `RingKind`, `InsetOptions`, `InsetBuild`, `InsetError`, `carve_by_winding`, `drop_interior_constraints`, `winding_number`, `orient2d`, `incircle` | [13](13-authored-geometry.md) |
